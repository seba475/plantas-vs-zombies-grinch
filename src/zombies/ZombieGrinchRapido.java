...
/**
 * Clase ZombieGrinchRapido
 * Variante de zombie más veloz pero con menos vida.
 * Avanza desde la derecha hacia la izquierda, puede colisionar con plantas
 * y proyectiles.
 */
public class ZombieGrinchRapido {
    ...
    public ZombieGrinchRapido(int fila, double xInicio, double velocidad, int vida, double escala, Tablero tablero) {
        this.fila = fila;
        this.x = xInicio;
        ...
        this.imgZombie = Herramientas.cargarImagen("imagenes/grinchRapido.png");
    }
